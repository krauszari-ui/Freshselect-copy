...
const VIEWER_PERMISSIONS: Permission[] = [
  ...
  PERMISSIONS.AUDIT_VIEW, PERMISSIONS.OVERPAYMENT_VIEW, PERMISSIONS.GUIDANCE_VIEW,
];
...
const COMPLIANCE_ROLE_PERMISSIONS: Record<ComplianceRole, Permission[]> = {
  ...
  compliance_reviewer: [
    ...
    PERMISSIONS.GUIDANCE_VIEW, PERMISSIONS.GUIDANCE_MANAGE,
  ],
  program_manager: [
  ...
  attorney: [
    ...
    PERMISSIONS.DOCUMENT_VIEW, PERMISSIONS.AUDIT_VIEW,
    PERMISSIONS.GUIDANCE_VIEW, PERMISSIONS.GUIDANCE_MANAGE,
    PERMISSIONS.LEGAL_REVIEW, PERMISSIONS.PRIVILEGED_VIEW,
  ],
